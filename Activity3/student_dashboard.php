...
<head>
    ...
    <style>
        ...
        .enrolled-badge { background: #2ecc71; color: white; padding: 5px 10px; border-radius: 4px; font-size: 0.9em; }
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item"><a href="#attendance" class="nav-link active" data-section="attendance">My Attendance</a></li>
