...
CREATE TABLE IF NOT EXISTS sessions (
    ...
    attendance_code VARCHAR(10) DEFAULT NULL, -- Code for students to mark attendance
    code_expires_at DATETIME DEFAULT NULL, -- When the code expires
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (course_id) REFERENCES courses(course_id)
);

-- Attendance Codes Table (for tracking code generation history)
